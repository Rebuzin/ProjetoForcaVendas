...
public class ItemController {
    ...
    public String validaItem(String codigo, String descricao, String vlrUnitario, String unMedida){
        ...
        if(codigo == null || codigo.isEmpty()){
            mensagem += "O codigo do item deve ser informado!\n";
        }else{
            try{
                ...
                mensagem += "O codigo do item deve ser número válido!\n";
            }

        }
        if(descricao == null || descricao.isEmpty()){
            mensagem += "a Descrição do item deve ser informado!\n";
        }
        if(vlrUnitario == null || vlrUnitario.isEmpty()){
            mensagem += "O Valor Unitário do item deve ser informado!\n";
        }
        if(unMedida == null || unMedida.isEmpty()){
            mensagem += "A Unidade de Medida do item deve ser informada!\n";
        }
        return mensagem;
    }
